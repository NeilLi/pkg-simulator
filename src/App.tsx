      ...
      <div className="container">
        <div className="header">
          <div>
            ...
            <h1 className="title">Runtime Mission Generator</h1>
        ...
        <div className="card">
          <div className="grid">
            ...
            <div className="field">
              ...
              <textarea
                readOnly
                value="Mission requests are generated by Gemini, evaluated by PKG policy, and appended to unified runtime memory."
              />
            </div>
          </div>
